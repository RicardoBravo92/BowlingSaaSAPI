...
async def seed_infra():
    async with AsyncSessionLocal() as db:
        ...
        # Create Lanes
        lane1 = Lane(number="01", type=LaneType.PREMIUM)
        lane2 = Lane(number="02", type=LaneType.PREMIUM)
        lane3 = Lane(number="03", type=LaneType.PREMIUM)
        lane4 = Lane(number="04", type=LaneType.NORMAL)
        lane5 = Lane(number="05", type=LaneType.NORMAL)
        lane6 = Lane(number="06", type=LaneType.NORMAL)
        lane7 = Lane(number="07", type=LaneType.NORMAL)
        lane8 = Lane(number="08", type=LaneType.NORMAL)
        lane9 = Lane(number="09", type=LaneType.NORMAL)
